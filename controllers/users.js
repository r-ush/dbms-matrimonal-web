...
var { getAge } = require("../config/utils");
  ...
  Users.findOne({
    ...
    .then(async (result) => {
      ...
      if (
        ...
        result.personaldetails.religion != null &&
        result.personaldetails.religion != "" &&
        result.personaldetails.religion != "-"
      ) {
        await updateReligion(req, result.personaldetails.religion);
      }
      if (
        result.personaldetails.education != null &&
        result.personaldetails.education != "" &&
        result.personaldetails.education != "-"
      ) {
