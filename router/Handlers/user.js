...
app.post(
  "/getDataByPagingfunction",
  middleware.checkSessionElseProfile,
  controllers.users.getDataByPagingfunction
);

app.get(
  "/getRecommendationUser",
  middleware.checkSessionElseProfile,
  controllers.recommendation.getRecommendationUser
);

app.get(
  "/:id",
  middleware.checkSessionElseProfile,
  controllers.users.getparticularuser
);
